...
<div class="profile">
      ...
      <a href="update_profile_model.php" class="btn btn-primary">Edit Models profile</a>
      <a href="login.php?logout=<?php echo $user_id; ?>"  onClick="log out()" class="btn btn-dark">logout</a>
</div>




		<span style="float:right;"><a href="mupload.php"><button class="btn-primary">Upload New image </button></a></span>
		<br><br>
	...
	<?php $res=mysqli_query($conn,"SELECT * from mod_gallery where user_id='$user_id' ORDER by id DESC");
			while($row=mysqli_fetch_array($res)) 
			{
			    	 
				echo '<div class="post_img"> 
                  <img src="mgallery/'.$row['image'].'"style="height:350px;width: 350px;border-radius:5%;">
                  <div class="post_con">
				  <h5>'.$row['title'].'</h5> 
